<!--
  GENERATED from meshcoresim/docs/shortcomings.md - do not edit this file.
...
The reason this page exists: *"The simulator is kinder
...
FEC, dewhitening, the explicit header and the payload CRC (the LoRa coding chain).
...
the LoRa coding chain, and two captured frames are checked in as golden vectors that
...
The *harness* for that comparison now exists (the validation package, MSIM-28): it
