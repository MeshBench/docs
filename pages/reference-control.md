...
The clients document a typed shape over part of this surface. `Call` reaches all
of it, and what `Call` takes is below.
...
**Session and lifecycle** - [`app.quit`](#app-quit) · [`log.path`](#log-path) · [`logs.export`](#logs-export) · [`session.checkpoint`](#session-checkpoint) · [`session.checkpoints`](#session-checkpoints) · [`session.describe`](#session-describe) · [`session.journal`](#session-journal) · [`session.list`](#session-list) · [`session.restore`](#session-restore) · [`session.status`](#session-status) · [`ui.keep_above`](#ui-keep-above) · [`ui.said`](#ui-said) · [`ui.scale`](#ui-scale) · [`ui.state`](#ui-state)
...
**Firmware** - [`firmware.build`](#firmware-build) · [`firmware.build_failed`](#firmware-build-failed) · [`firmware.built`](#firmware-built) · [`firmware.delete`](#firmware-delete) · [`firmware.details`](#firmware-details) · [`firmware.download`](#firmware-download) · [`firmware.failed`](#firmware-failed) · [`firmware.import`](#firmware-import) · [`firmware.installed`](#firmware-installed) · [`firmware.library`](#firmware-library) · [`firmware.needed`](#firmware-needed) · [`firmware.published`](#firmware-published) · [`firmware.rescan`](#firmware-rescan) · [`firmware.set`](#firmware-set) · [`firmware.start`](#firmware-start) · [`firmware.started`](#firmware-started) · [`firmware.state`](#firmware-state) · [`firmware.update`](#firmware-update) · [`firmware.window`](#firmware-window) · [`firmware.wipe`](#firmware-wipe)

**Console and fleet** - [`console.cli`](#console-cli) · [`console.read`](#console-read) · [`console.type`](#console-type) · [`fleet.replies`](#fleet-replies) · [`fleet.send`](#fleet-send)

**Companion** - [`companion.add_channel`](#companion-add-channel) · [`companion.advert`](#companion-advert) · [`companion.configure`](#companion-configure) · [`companion.connect`](#companion-connect) · [`companion.disconnect`](#companion-disconnect) · [`companion.raw`](#companion-raw) · [`companion.read`](#companion-read) · [`companion.refresh`](#companion-refresh) · [`companion.scope`](#companion-scope) · [`companion.send`](#companion-send) · [`companion.state`](#companion-state)

**Serving to real clients** - [`bench.drop`](#bench-drop) · [`bench.refresh`](#bench-refresh) · [`bench.serve`](#bench-serve) · [`bench.stray`](#bench-stray) · [`sdr.serve`](#sdr-serve) · [`sdr.stop`](#sdr-stop)
...
**Boundary, import and feeds** - [`boundary.accept`](#boundary-accept) · [`boundary.list`](#boundary-list) · [`boundary.load`](#boundary-load) · [`boundary.prune`](#boundary-prune) · [`boundary.remove`](#boundary-remove) · [`boundary.set`](#boundary-set) · [`feed.failed`](#feed-failed) · [`feed.pull`](#feed-pull) · [`feed.set`](#feed-set) · [`feed.stop`](#feed-stop) · [`import.commit`](#import-commit) · [`import.describe`](#import-describe) · [`import.failed`](#import-failed) · [`import.fetch`](#import-fetch) · [`import.set`](#import-set) · [`import.set_source`](#import-set-source) · [`infer.apply`](#infer-apply) · [`infer.progress`](#infer-progress) · [`infer.result`](#infer-result) · [`infer.run`](#infer-run)

**Experiments and sweeps** - [`experiment.base`](#experiment-base) · [`experiment.compare`](#experiment-compare) · [`experiment.define`](#experiment-define) · [`experiment.export`](#experiment-export) · [`experiment.finished`](#experiment-finished) · [`experiment.results`](#experiment-results) · [`experiment.seeds`](#experiment-seeds) · [`experiment.senders`](#experiment-senders) · [`experiment.start`](#experiment-start) · [`experiment.state`](#experiment-state) · [`experiment.stop`](#experiment-stop) · [`experiment.vary`](#experiment-vary) · [`sweep.run`](#sweep-run) · [`sweep.set`](#sweep-set)

**Validation** - [`validate.calibrate`](#validate-calibrate) · [`validate.compare`](#validate-compare) · [`validate.failed`](#validate-failed) · [`validate.fetch`](#validate-fetch) · [`validate.uncalibrate`](#validate-uncalibrate)

**The radio model** - [`environ.failed`](#environ-failed) · [`environ.fetch`](#environ-fetch) · [`environ.fetched`](#environ-fetched) · [`environ.list`](#environ-list) · [`radio.preset`](#radio-preset) · [`rf.environment`](#rf-environment) · [`rf.excess_loss`](#rf-excess-loss) · [`rf.mode`](#rf-mode) · [`rf.realism`](#rf-realism) · [`rf.toggle`](#rf-toggle)
